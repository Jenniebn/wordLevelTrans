Tencent AI Lab embedding corpus for Chinese words and phrases (v0.2.0 released in Dec 24, 2021)
URL: https://ai.tencent.com/ailab/nlp/data/tencent-ailab-embedding-zh-d200-v0.2.0-s.tar.gz
...
The pre-trained embeddings are in tencent-ailab-embedding-zh-d200-v0.2.0-s.txt.
